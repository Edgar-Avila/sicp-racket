...
\label{sec:org5493c7a}
\subsection{The elements of programming}
\label{sec:orgc2baafd}
...
\label{sec:org468e42b}
\subsubsection{Recursive processes}
\label{sec:orgfa09748}
Consider:
\begin{verbatim}
(define (factorial n)
  (if (= n 1)
...
\label{sec:org5fc0bfe}
\subsubsection{Procedures as arguments}
\label{sec:org93dabbb}
